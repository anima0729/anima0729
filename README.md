...
:black_nib: Now I'm learning
 - To Use Language : Python, C++, Java, ...
 - To Use Library : Pytorch, TensorFlow, ...
 - To Use Device(OS) : PC(Linux, Windows), Jetson Orin(Linux, ROS), ...
...
- **`IJCAI` [BankTweak: Adversarial Attack against Multi-Object Trackers by Manipulating Feature Banks](https://www.ijcai.org/proceedings/2025/206), IJCAI 2025**
